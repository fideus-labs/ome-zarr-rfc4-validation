...
CASES = [
    ...
    dict(id="TC-25", title="Real heart apex-to-base (Janelia)", format="ome-zarr",
         input=f"{D}/ome-zarr/heart_janelia_apex_base.ome.zarr",
         requirements=["R9"], expect="valid",
    ...
    dict(id="TC-42", title="Heart EM, flipped (base-to-apex)", format="ome-zarr",
         input=f"{D}/ome-zarr/heart_janelia_flip.ome.zarr",
         requirements=["R7", "R9"], expect="valid",
